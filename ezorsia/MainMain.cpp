...
bool MainMain::CustomLoginFrame = PatchSettings::UseCustomLoginFrame;
bool MainMain::bigLoginFrame = false;
bool MainMain::ownCashShopFrame = PatchSettings::UseCustomCashShopFrame;
bool MainMain::EzorsiaV2WzIncluded = false;
bool MainMain::useV62_ExpTable = PatchSettings::UseV62ExpTable;
...
const char* MainMain::m_sRedirectIP = PatchSettings::ServerIp;
...
MainMain::MainMain(std::function<void()> pPostMutexFunc)
{
	...
	const unsigned int sleepTime = reader.GetInteger("debug", "sleepTime", 0);
