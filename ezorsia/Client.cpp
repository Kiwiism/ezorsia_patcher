...
void Client::UpdateGameStartup() {
	...
	Memory::WriteString(0x00AFE084, PatchSettings::ServerIp);
	Memory::WriteString(0x00AFE084 + 16, PatchSettings::ServerIp);
	Memory::WriteString(0x00AFE084 + 32, PatchSettings::ServerIp);
...
#endif
#if PATCH_REMOVE_STARTUP_LOGOS
	{
		Memory::FillBytes(0x0062EE54, 0x90, 21);	// no Logo @launch //Thanks Denki!!
	}
#endif

	const int msgAmnt = PatchSettings::GainMessageCount;
